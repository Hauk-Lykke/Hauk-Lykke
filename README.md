...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; padding: 10px; border: 1px solid #ddd; border-radius: 5px;">
  ...
  <div style="text-align: center;">
    <img src="photos/Artery_test_20250114.png" alt="Algorithmic design plot" style=" margin-left: auto; margin-right: auto; width: 80%; object-fit: cover; border-radius: 5px;" />
    <p style="margin-top: 10px; font-size: 14px; color: #666;">
